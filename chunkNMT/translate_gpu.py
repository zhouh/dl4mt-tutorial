...
def translate_file(options, model, word_dict, word_idict_trg, source_file, saveto, ck=20, wk=3,k=8, normalize=True, n_process=5, chr_level=False):
...
def main(model, pklmodel, dictionary, dictionary_target, source_file, saveto, ck=12, wk=3,k=8,
         normalize=True, n_process=5, chr_level=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ck', type=int, default=12)
    parser.add_argument('-wk', type=int, default=3)
